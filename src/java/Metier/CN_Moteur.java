 ...
 * @author Valentin
 */
public class CN_Moteur {
    
    private int id_CN_Moteur;
    ...
    /**
     * @return the id_CN_Moteur
     */
    public int getId_CN_Moteur() {
        return id_CN_Moteur;
    }

    /**
     * @param id_CN_Moteur the id_CN_Moteur to set
     */
    public void setId_CN_Moteur(int id_CN_Moteur) {
        this.id_CN_Moteur = id_CN_Moteur;
    }
